...
def classify_issue(issue: dict[str, Any]) -> dict[str, Any]:
    """
    Classify a GitHub issue's title and body according to .agents/skills/issue-analyze/SKILL.md.

    This function is the deterministic Python implementation of the formal specification
    defined in .agents/skills/issue-analyze/SKILL.md. The contract between this implementation
    and the spec is verified by tests/test_skill_contract.py.

    Returns dict with keys: issue_number, severity, label, owner, reason.
    """
    ...
    # 2. Label Categorization (per SKILL.md keyword mappings)
    ...
    # 3. Owner Detection (per SKILL.md: @username or "unassigned")
...
def detect_duplicates(
    ...
    This function is the deterministic Python implementation of the formal specification
    defined in .agents/skills/duplicate-detector/SKILL.md. The contract between this
    implementation and the spec is verified by tests/test_skill_contract.py.
    """
...
def rank_priorities(
    ...
    This function is the deterministic Python implementation of the formal specification
    defined in .agents/skills/priority-ranker/SKILL.md. The contract between this
    implementation and the spec is verified by tests/test_skill_contract.py.
...
def build_analyze_summary(
    ...
    This function is the deterministic Python implementation of the formal specification
    defined in .agents/skills/analyze-summary/SKILL.md. The contract between this
    implementation and the spec is verified by tests/test_skill_contract.py.
    """
